...
class QPDAxiconCameraFunctionalityMixin(QPDFunctionalityMixin):
    """
    This class is for a camera that is being used like a QPD. This 
    functionality handles signals generated by an axicon-based focus
    """
    def adjustAOI(self, dx, dy):
        """
        Adjust the camera AOI.
