#!/usr/bin/env python
"""
FLIR Autofocus Camera

based on classes for the point grey cameras
...
import storm_control.sc_hardware.FLIR.blackflyLockCamera as blackflyLockCamera
...
class BlackflyLockCamera(hardwareModule.HardwareModule):
    """
    HAL module that interfaces with a Blackfly camera
    """
